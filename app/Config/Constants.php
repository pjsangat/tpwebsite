...
switch (ENVIRONMENT) {
    ...
    case 'development':
    case 'local':
        $ASSETS_URL = BASE_URL . 'assets/dist/';
        $IMG_URL = BASE_URL . 'assets/img/';
        $WEBFONTS_URL = BASE_URL . 'assets/webfonts/';
        // $DATA_URL = get_env('APP_DATA_URL');
        $IMG_DATA_URL = BASE_URL . 'assets/img/';
        $COOKIE_DOMAIN = '';
        break; 
}
...
define('COMPILED_ASSETS_PATH', '__compiled_assets__' . DIRECTORY_SEPARATOR);
